...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dev-key-change-in-production-shopyaar-2026')
...
# Google OAuth - prompt select_account so first time asks which account
